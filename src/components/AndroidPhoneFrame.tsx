...
const AndroidPhoneFrame: React.FC<AndroidPhoneFrameProps> = ({ imageUrl, alt, className }) => (
  <div
  ...
  >
    ...
    <div
      className="absolute left-[18px] top-[28px] w-[184px] h-[421px] rounded-[20px] overflow-hidden bg-black z-0 shadow-inner"
      style={{
